    ...
    <main className="home">
      ...
      <style jsx>{`
        ...
        :global(.trial-pill){
          ...
          font-size:13px; font-weight:800; text-align:center; letter-spacing:.01em;
          color:#3a2600;
        ...
        :global(.trial-pill__line){ line-height:1.1; }
        :global(.trial-pill__price){ font-size:16px; margin-top:3px; }
