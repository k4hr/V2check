                      ...
                      {badges.map((b, i) => (
                        <span
                          ...
                          style={{
                            ...
                            background: b.includes('%') ? 'rgba(255,200,0,.10)' : 'rgba(255,255,255,.08)',
                            border: `1px solid ${b.includes('%') ? 'rgba(255,200,0,.6)' : '#555'}`,
                            color: b.includes('%') ? '#ffd66b' : '#ddd'
                          }}
                        >
                          {b}
                        </span>
