...
export default function EmailForReceiptPage() {
  ...
  function onSubmit() {
    if (!valid(email.trim())) { setMsg(T.invalid); return; }
    ...
    <main>
      ...
      <style jsx>{`
        ...
        .email-line input {
          ...
          background:#121722; border:1px solid rgba(255,255,255,.08); color:#fff;
        }
        .go {
          width:100%; padding:14px 16px; border-radius:14px;
          background:linear-gradient(135deg, rgba(120,170,255,.35), rgba(120,170,255,.18));
          border:1px solid rgba(120,170,255,.45); color:#fff; font-weight:800;
        }
      `}</style>
    </main>
  );
