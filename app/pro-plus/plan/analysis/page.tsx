...
import { PROMPT_ANALYSIS } from './prompt';
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: 'assistant',
      content:
        'Это чат «Анализ — Pro+». Кратко опишите вашу бизнес-идею/рынок/аудиторию. Можно попросить «полный анализ» или конкретное: «сделай УТП», «собери лендинг», «контент-идеи для …», «DM для первых клиентов».',
    },
  ]);
        ...
        <div style={{ padding:10, borderTop:'1px solid var(--border)' }}>
          <div style={{ display:'flex', gap:8 }}>
            <input
              ...
              placeholder="Опишите идею/рынок/аудиторию или попросите «полный анализ»"
